...
/**
 * Static fixture matching the "Holdings API" dummy response supplied in the
 * assignment brief, verbatim. In a real backend this would come from a
 * portfolio/ledger service; here it's frozen so the tool's math is checkable
 * by hand against the brief's own numbers.
 */
export const HOLDINGS_FIXTURE: Omit<Holding, "id">[] = [
  {
    coin: "USDC",
    coinName: "USDC",
